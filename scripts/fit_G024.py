"""fit_G024.py
Run amoeba2 on single G024 pixel
...
def main(idx, infile):
    ...
    try:
        ...
        opt.add_priors(
            ...
            prior_velocity=[95.0, 10.0],  # mean and width of velocity prior (km/s)
...
if __name__ == "__main__":
    ...
    if htc_type == "slurm":
        infile = f"G024/{idx}.pkl"
        outfile = f"G024_results/{idx}_amoeba2.pkl"
    else:
        infile = f"{idx}.pkl"
